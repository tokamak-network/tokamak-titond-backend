...
type IK8s interface {
	...
	CreatePersistentVolume(namespace string, name string, pv *corev1.PersistentVolume) (*corev1.PersistentVolume, error)
	CreatePersistentVolumeClaim(namespace string, pvc *corev1.PersistentVolumeClaim) (*corev1.PersistentVolumeClaim, error)
	CreatePersistentVolumeClaimWithAppSelector(namespace string, appName string, pvc *corev1.PersistentVolumeClaim) (*corev1.PersistentVolumeClaim, error)
