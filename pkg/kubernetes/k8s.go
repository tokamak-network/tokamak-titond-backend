...
type IK8s interface {
	...
	CreatePersistentVolumeClaim(namespace string, label map[string]string, storage string, pvc *corev1.PersistentVolumeClaim) (*corev1.PersistentVolumeClaim, error)
	CreatePersistentVolume(label map[string]string, storage string, pv *corev1.PersistentVolume) (*corev1.PersistentVolume, error)
